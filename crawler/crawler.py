...
class BilibiliCommentCrawler:
    ...
    def __init__(self, delay=1.0, output_dir="data"):
        ...
        # B站 Cookie 可提升 API 请求频次上限，减少验证码
        bili_cookie = os.getenv("BILIBILI_COOKIE", "") or (
            "buvid3=D1189D08-E3E3-CEA0-F91F-EC6FD1D9673E63066infoc; "
            "b_nut=1783299763; "
            "SESSDATA=7ed96965%2C1798893759%2C62bb2%2A72CjCqFYP_p5FRBounjAZ0E2rwFEAADEDS9u18ofg7wpEvnhosCkrNjlZvOP8tVg27tgwSVnJYd3dMbk1RSFdjd3VRY2thU0JLdkNURDV2Y0lWZmNrTkc4Z1lfNXFYVENtczVtOEJsOHZLOXRFdUY3Yk55Z1hoZ1o1d2ZzRldzOE9vVVNwN0V0SW1BIIEC; "
            "bili_jct=26e9e2bc120743c7d81aa08c9513d589; "
            "DedeUserID=517014770; "
            "DedeUserID__ckMd5=60cd210a051c1a9c; "
            "bili_ticket=eyJhbGciOiJIUzI1NiIsImtpZCI6InMwMyIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3ODQxOTM0MDIsImlhdCI6MTc4MzkzNDE0MiwicGx0IjotMX0.KdsB3czwRDNAofWqO85kKFeNk7d06ytHMdB2XqQkDUc; "
            "bili_ticket_expires=1784193342; "
            "buvid4=D7C8CBA6-9671-557C-2F0E-D35C53A46A1964423-026070609-F0FA+7P4E6tRBpChhQq67A%3D%3D"
        )
        if bili_cookie:
            self.headers["Cookie"] = bili_cookie
            print("[B站] 已加载 Cookie，将使用登录态访问")
        else:
            print("[B站] 未配置 Cookie，API 频次可能受限")
...
class ToutiaoSearchCrawler:
    ...
    def __init__(self, delay=1.0, output_dir="data"):
        ...
        # 头条 Cookie 可降低搜索结果页触发验证码的概率
        toutiao_cookie = os.getenv("TOUTIAO_COOKIE", "") or (
            "tt_webid=7662218151249217058; "
            "csrftoken=ff71bbd031dfa71cdf21698e8b9e2814; "
            "s_v_web_id=verify_mrk327ou_CQyLb6Tk_3oU0_4xol_9ZWX_jsRBrdeKUiN5; "
            "passport_csrf_token=184291420db8c1d448f501de52f8c4d2; "
            "passport_csrf_token_default=184291420db8c1d448f501de52f8c4d2; "
            "sid_guard=cfdb95d8cdf0790d5196f316ce2c3f6d%7C1783999229%7C5184001%7CSat%2C+12-Sep-2026+03%3A20%3A30+GMT; "
            "uid_tt=db0968c081951f897750fb775bc177b7; "
            "sid_tt=cfdb95d8cdf0790d5196f316ce2c3f6d; "
            "sessionid=cfdb95d8cdf0790d5196f316ce2c3f6d; "
            "toutiao_sso_user=7520872022295c03a9e6d2f7797c7d76; "
            "sso_uid_tt=9e16ddfcc575f295e06d2533d23fe6f3; "
            "odin_tt=609824ad84060f146104fb16efd1f13f7bd6c7caae56efbe890545fedb66d4a18542bc9ed72c0ead7039c2620b6acf00; "
            "tt_scid=OO.xDLJw5PQgvXLHRdipfssaPY-.n6HFija5ZuTP.NFvZ.otC.dD7uBpqEqqpMeQ8a20"
        )
        if toutiao_cookie:
            self.headers["Cookie"] = toutiao_cookie
            print("[头条] 已加载 Cookie，将使用登录态访问")
        else:
            print("[头条] 未配置 Cookie，搜索结果可能受限")
        self.all_comments: List[Dict[str, Any]] = []
